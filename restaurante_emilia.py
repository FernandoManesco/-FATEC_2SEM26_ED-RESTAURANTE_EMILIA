...
def abrir_produtos():
    messagebox.showinfo("Produtos", "Aqui vai abrir o Cadastro de Produtos.")

def abrir_comanda():
    messagebox.showinfo("Comanda", "Aqui vai abrir a Comanda / Vendas.")

def abrir_caixa():
    messagebox.showinfo("Caixa", "Aqui vai abrir o Caixa.")
